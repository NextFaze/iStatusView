...
Pod::Spec.new do |s|
  s.name             = 'iStatusView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of iStatusView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/awulf/iStatusView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'awulf' => 'awulf@nextfaze.com' }
  s.source           = { :git => 'https://github.com/awulf/iStatusView.git', :tag => s.version.to_s }
